    const sbtIconBase = window.RENAISS_SBT_ICON_BASE || "https://8nothtoc5ds7a0x3.public.blob.vercel-storage.com/SBT/minified/";
    const sbtRows = Array.isArray(window.RENAISS_SBT_CATALOG) ? window.RENAISS_SBT_CATALOG : [];
